...
Country_Index <- readRDS("C:/Users/shreya/Documents/JE Jie/Generate Cases/Data/Country_Index.Rds") # index of countries
Coord_Regions_Final <- readRDS("C:/Users/shreya/Documents/JE Jie/Generate Cases/Data/Coord_Regions_Final.Rds") # index of pixel
...
pop_data1 <- readRDS("C:/Users/shreya/Documents/JE Jie/Generate Cases/Data/Naive_pop_24ende_1950_2015.rds") # Population by age at each region
...
foi_data1 <- readRDS("C:/Users/shreya/Documents/JE Jie/Generate Cases/Data/ende_24_regions_lambda_extr_or.rds") # FOI result from catalytic models at each region
...
Endemic_DF_WP_Imputed_Land <- readRDS("C:/Users/shreya/Documents/JE Jie/Generate Cases/Data/Endemic_DF_WP_Full_Cov_Imputed_Land.Rds") # dataframe containing all imputed features (no missing values here)
